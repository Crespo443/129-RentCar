                     ...
                     <ul class="flex flex-col  font-medium lg:flex-row lg:space-x-8 lg:mt-0 ">
                         ...
                         <li>
                             <a href=\"/admin/reservations\">
                                 <div class=\"group text-center\">
                                     <div class=\"group-hover:cursor-pointer\">Reservasi</div>
                                     <div class=\"block invisible bg-pr-400 w-16 h-1 rounded-md text-center -bottom-1
                                         mx-auto relative group-hover:visible\">
                                     </div>
                             </a>
                         </li>
                     </ul>
                         ...
                         <div class="rounded-xl shadow-2xl p-6 text-white transform hover:scale-105 transition duration-300"
                             ...
                             <div class="flex items-center">
                                 ...
                                 <div class="ml-4">
                                     ...
                                     <p class="text-2xl font-bold">Rp {{ number_format($totalRevenue, 0, ',', '.') }}
                                     </p>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="rounded-xl shadow-2xl p-6 text-white transform hover:scale-105 transition duration-300"
                             ...
                             <div class="flex items-center">
                                 ...
                                 <div class="ml-4">
                                     ...
                                     <p class="text-5xl font-bold">{{ $totalReservations }}</p>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="rounded-xl shadow-2xl p-6 text-white transform hover:scale-105 transition duration-300"
                             ...
                             <div class="flex items-center">
                                 ...
                                 <div class="ml-4">
                                     ...
                                     <p class="text-5xl font-bold">{{ $activeReservations }}</p>
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="rounded-xl shadow-2xl p-6 text-white transform hover:scale-105 transition duration-300"
                             ...
                             <div class="flex items-center">
                                 ...
                                 <div class="ml-4">
                                     ...
                                     <p class="text-sm opacity-75">Ulasan Baru: {{ $pendingReviews }}</p>
                                 </div>
                             </div>
                         </div>
                     </div>
                                 ...
                                 <div class="space-y-4">
                                     <div
                                         ...
                                         <div class="text-right">
                                             <p class="text-2xl font-bold text-green-600">{{ $activeReservations }}
                                             </p>
                                         </div>
                                     </div>
                                     <div
                                         ...
                                         <div class="text-right">
                                             <p class="text-2xl font-bold text-gray-600">{{ $completedReservations }}
                                             </p>
                                     ...
                                     <div
                                         ...
                                         <div class="text-right">
                                             <p class="text-2xl font-bold text-red-600">{{ $canceledReservations }}
                                             </p>
                                         </div>
                                     </div>
                                 </div>
                                 ...
                                 <div class="space-y-3">
                                     @forelse($popularCars as $car)
                                         <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                             <div>
                                                 <p class="font-medium text-sm">{{ $car->brand }}
                                                     {{ $car->model }}</p>
                                                 <p class="text-xs text-gray-600">{{ $car->reservations_count }}
                                                     Pemesanan</p>
                                             </div>
                                             <div class="text-right">
                                                 <p class="font-semibold text-sm text-green-600">Rp
                                                     {{ number_format($car->reservations_sum_total_price ?? 0, 0, ',', '.') }}
                                                 </p>
                                                 <div class="flex items-center">
                                                     @for ($i = 1; $i <= 5; $i++)
                             ...
                             <div class="bg-white rounded-xl shadow-lg p-6">
                                 ...
                                 <div class="space-y-3">
                                     ...
                                     @forelse($categoryRevenue as $cat)
                                         ...
                                         @endphp
                                         <div
                                             class="p-4 bg-gradient-to-r from-{{ $color['from'] }} to-{{ $color['to'] }} rounded-lg border-l-4 border-{{ $color['border'] }}">
                                             <div class="flex justify-between items-center mb-2">
                                                 <div class="flex items-center space-x-3">
                                                     <div>
                                                         <p class="font-semibold text-gray-800">{{ $cat->category }}
                                                         </p>
                                                     </div>
                                                 </div>
                                                 <p class="text-lg font-bold text-{{ $color['text'] }}">Rp
                             ...
                             <div class="bg-white rounded-xl shadow-lg p-6">
                                 ...
                                 <div class="space-y-4">
                                     ...
                                     <div class="flex justify-between items-center">
                                         ...
                                         <span class="font-semibold text-green-600">{{ $approvedReviews }}</span>
                                     </div>
                                     <div class="flex justify-between items-center">
                                         <span class="text-sm text-gray-600">Menunggu</span>
                                         <span class="font-semibold text-yellow-600">{{ $pendingReviewsCount }}</span>
                                     </div>
                                     ...
                                     <div class="mt-4">
                                         ...
                                         @for ($rating = 5; $rating >= 1; $rating--)
                                             @php
                                                 ...
                                                 $percentage =
                                                     $approvedReviews > 0 ? ($count / $approvedReviews) * 100 : 0;
                                             @endphp
                                             <div class="flex items-center mb-1">
                                                 <span class="text-xs w-4">{{ $rating }}★</span>
                                         ...
                                         <tr class="text-gray-700 ">
                                             ...
                                             <td class="px-4 py-3 text-sm relative">
                                                 <div class="relative inline-block text-left">
                                                     <button
                                                         onclick="openActionsModal(1, 'BMW X5', 'Pending', 'Active')"
                                                         ...
                                                         id="menu-button-1" aria-expanded="true"
                                                         aria-haspopup="true">
                                             ...
                                             <td class="px-4 py-3 text-sm relative">
                                                 <div class="relative inline-block text-left">
                                                     <button
                                                         ...
                                                         class="inline-flex justify-center w-full px-2 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                                         id="menu-button-2" aria-expanded="true"
                                                         aria-haspopup="true">
                                                         <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg"
                                                             fill="currentColor" viewBox="0 0 16 16">
                                                             <path
